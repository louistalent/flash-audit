	...
	return (
		<Layout>
			<section className="request-section">
				<div className="container mx-auto flex flex-col py-16 sm:py-32 text-center sm:text-left">
					<div className="row">
						<div className="col-sm-12 col-md-6 mb-9">
							<h4 className="primary-color">FLASH AUDIT</h4>
							<h1 className="font-bold">
								<div className="">
									Ensure trust in your projects with a&nbsp;
							...
							<h5 className="grey-color">
								Flash Audit, audited smart contracts on Bsc, Ethereum, Avalanche, Polygon, Solana, Fantom, Cronos… We are the No. 1 Audit company in France in the cryptographic world.
							</h5>
						...
						<div className="col-sm-12 col-md-6 mb-9">
							<img src="/assets/images/flash-audit-section.png" alt="" />
						</div>
					</div>
				</div>
			</section>
